...
##    POINT*.csv files as lists from HISTORIC             ##
##    simulations.                                        ##
##                      AND                               ##
##    Calculate                                           ##
...
setwd("C:/Users/Brooke/Desktop/SOIL_BGC_TESTBED/FEF_cal2")
library(tidyverse)
library(data.table)
library(stringr)
...
CASAten <- lapply(list.CASA2, '[', c(28835:32485),)            # subset last ten years
MIMICSten <- lapply(list.MIMICS2, '[',c(28835:32485),)         # subset last ten years
...
CBALANCEten <- lapply(list.CBALANCE, '[', c(28835:32485),)            # subset last ten years
NBALANCEten <- lapply(list.NBALANCE, '[',c(28835:32485),)         # subset last ten years
...
############################################################################
## see file: "plotting_historic_final.R"                                  ##
